...
/_ Interactive Learning Checkpoint _/
.learning-checkpoint {
display: grid;
...
/_ Responsive Design for Checkpoint _/
...
/_ Westrum Culture Types Styling _/
...
/_ Performance Statistics Styling _/
.performance-stats {
display: grid;
grid-template-columns: repeat(3, 1fr);
gap: 1rem;
