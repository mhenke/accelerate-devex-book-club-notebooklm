...
- [AWS Certified DevOps Engineer](https://aws.amazon.com/certification/certified-devops-engineer-professional/) — Official AWS certification for DevOps professionals
- [DevOps Institute Certifications](https://www.devopsinstitute.com/certifications/) — Industry-recognized DevOps certifications

### Training Resources

- [IBM DevOps Professional Certificate](https://www.coursera.org/professional-certificates/ibm-devops-and-software-engineering) — Coursera professional certificate
- [Introduction to DevOps](https://www.edx.org/course/introduction-to-devops) — Linux Foundation course on DevOps fundamentals

### Research Resources

- [Annual State of DevOps Reports](https://dora.dev/research/2024/dora-report/) — Latest DORA findings
- [DORA Capabilities Overview](https://dora.dev/capabilities/) — Technical and cultural capabilities
- [DORA Research](https://dora.dev/research/) — Additional studies and measurement guidance
- [DevOps Research and Assessment (DORA)](https://dora.dev/) — Ongoing research program
