...
<div class="meeting-navigation" markdown="0">
  <div class="nav-item prev">
    <a href="{{ '/meetings/meeting-3/' | relative_url }}">
      ...
      <span>Previous: Management</span>
    </a>
  </div>
  
  <div class="progress-container">
    <div class="progress-text">Meeting 4 of 4</div>
    <div class="progress-bar">
      <div class="progress-fill" style="width: 100%"></div>
    </div>
  </div>
  
  <div class="nav-item next celebration">
    <a href="{{ '/transformation-complete/' | relative_url }}">
...
.nav-item.next.celebration:hover {
...
.nav-item.next.celebration::before {
  content: "🎉";
  position: absolute;
  top: -5px;
  right: -5px;
...
:root {
  ...
  --meeting-4-secondary: #a78bfa;
  --meeting-4-light: #f5f3ff;
  --meeting-4-darker: #6d28d9;
}

/* Leadership Dimensions Grid */
.leadership-dimensions-grid {
  display: grid;
...
.coaching-before h4, .coaching-after h4 {
  margin: 0 0 1rem 0;
  color: var(--meeting-4-darker);
  font-size: 1.2rem;
  font-weight: 600;
...
/* Interactive Learning Checkpoint - Purple Theme */
.learning-checkpoint {
  display: grid;
...
.checkpoint-card:hover {
  ...
  border-color: var(--meeting-4-primary);
}
...
/* Assessment Buttons - Purple Theme */
.assessment-buttons {
  display: flex;
  flex-direction: column;
  gap: 0.75rem;
...
.assessment-btn.command-style {
  border-color: #f44336;
  color: #d32f2f;
}

.assessment-btn.command-style .radio-mark {
  border-color: #f44336;
}

.assessment-btn.command-style input:checked ~ .radio-mark {
  background: #f44336;
}

.assessment-btn.command-style input:checked ~ .radio-mark:after {
  content: "";
  position: absolute;
  top: 2px;
  left: 2px;
...
.assessment-btn.command-style:hover {
  background: #f44336;
  color: white;
  transform: scale(1.02);
}

.assessment-btn.command-style:has(input:checked) {
  background: #ffebee;
  border-color: #d32f2f;
  color: #d32f2f;
}

.assessment-btn.mixed-style {
  border-color: #ff9800;
  color: #f57c00;
}

.assessment-btn.mixed-style .radio-mark {
  border-color: #ff9800;
}

.assessment-btn.mixed-style input:checked ~ .radio-mark {
  background: #ff9800;
}

.assessment-btn.mixed-style input:checked ~ .radio-mark:after {
  content: "";
  position: absolute;
  top: 2px;
  left: 2px;
...
.assessment-btn.mixed-style:hover {
  background: #ff9800;
  color: white;
  transform: scale(1.02);
}

.assessment-btn.mixed-style:has(input:checked) {
  background: #fff8e1;
  border-color: #f57c00;
  color: #f57c00;
}

.assessment-btn.transformational-style {
  border-color: var(--meeting-4-primary);
  color: var(--meeting-4-darker);
}

.assessment-btn.transformational-style .radio-mark {
  border-color: var(--meeting-4-primary);
}

.assessment-btn.transformational-style input:checked ~ .radio-mark {
  background: var(--meeting-4-primary);
}

.assessment-btn.transformational-style input:checked ~ .radio-mark:after {
  content: "";
  position: absolute;
  top: 2px;
  left: 2px;
...
.assessment-btn.transformational-style:hover {
  background: var(--meeting-4-primary);
  color: white;
  transform: scale(1.02);
}

.assessment-btn.transformational-style:has(input:checked) {
  background: var(--meeting-4-light);
  border-color: var(--meeting-4-darker);
  color: var(--meeting-4-darker);
}
...
.readiness-checkbox input:checked ~ .checkbox-mark {
  background: var(--meeting-4-primary);
}
...
.readiness-checkbox:has(input:checked) {
  background: linear-gradient(135deg, var(--meeting-4-light), #e0e7ff);
  border-left-color: var(--meeting-4-darker);
  color: var(--meeting-4-darker);
}
...
.coaching-option input:checked ~ .radio-mark {
  background: var(--meeting-4-primary);
}

.coaching-option input:checked ~ .radio-mark:after {
  content: "";
  position: absolute;
  top: 2px;
  left: 2px;
...
.coaching-option:has(input:checked) {
  background: linear-gradient(135deg, var(--meeting-4-light), #e0e7ff);
  border-left-color: var(--meeting-4-darker);
  color: var(--meeting-4-darker);
}
