...
<div class="architecture-comparison">
  <div class="arch-side tight-coupled">
    ...
    <div class="arch-content">
      ...
      <ul>
        ...
        <li>📞 Constant coordination needed</li>
  ...
  <div class="arch-side loose-coupled">
    ...
    <div class="arch-content">
      ...
      <ul>
        <li>✅ Autonomous team work</li>
        <li>🚀 Faster feature delivery</li>
        <li>🛡️ Isolated failures</li>
...
<div class="architecture-assessment">
  <div class="assessment-card dependency-map">
    ...
    <div class="dependency-examples">
      <div class="dependency-item">🔴 Shared database</div>
      <div class="dependency-item">🟡 Release coordination</div>
      <div class="dependency-item">🟢 Independent services</div>
    </div>
  </div>
  ...
  <div class="assessment-card wip-current">
    ...
    <div class="wip-options">
      <div class="wip-option">📋 Task lists</div>
      <div class="wip-option">📊 Kanban board</div>
      <div class="wip-option">📈 Sprint board</div>
      <div class="wip-option">🤷 No tracking</div>
    </div>
  </div>
</div>
