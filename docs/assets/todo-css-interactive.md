...
- [x] Add NotebookLM and Claude icons (Font Awesome).
...
- [x] Design a tileable geometric/circuit pattern using CSS radial gradients.
- [x] Set opacity to 3% for subtlety.
- [x] Use DORA metric colors (blue, green, orange, red) for visual consistency.
- [x] Ensure seamless tiling and performance with fixed positioning.

## 10. Social Media Preview (Open Graph)

- [x] Add Open Graph meta tags to default layout for social media previews.
- [x] Add repository title and description via Jekyll variables.
- [x] Include Twitter Card support for broader social media compatibility.
- [x] Reference placeholder image path for future social media preview image.
