...
This is a **question bank** containing 40+ discussion questions for Meeting 2. **You will NOT use all of these questions.** Facilitators should select 6-8 questions that best fit their team's context for the **25-minute core discussion period** (the full 60-minute meeting includes other activities per the agenda).
