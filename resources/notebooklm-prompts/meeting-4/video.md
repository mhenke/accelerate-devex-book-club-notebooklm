...
Arrow diagram: Leadership → Practices → Metrics → Culture → Performance
...
Show progression: Measurement → Technical → Management → Leadership (all connected)
...
TRANSFORMATIONAL LEADERSHIP (Meeting 4) enables →
   TECHNICAL PRACTICES (Meeting 2) →
      LEAN MANAGEMENT (Meeting 3) →
         BETTER DORA METRICS (Meeting 1) →
            GENERATIVE CULTURE (Meeting 1) →
               SUSTAINABLE PACE (Meeting 3) →
                  BETTER PERFORMANCE →
